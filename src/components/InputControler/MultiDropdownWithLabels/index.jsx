...
const MultiDropdownWithLabels = ({fieldDetails, formikFunctions}) => {
  ...
  const firstInputOptions = fieldDetails.options?.[values['flex-direction']]?.custom || []
  const secondInputOptions = fieldDetails.options?.[values['flex-direction']]?.['space-evenly'] || []
  const thirdInputOptions = fieldDetails.options?.[values['flex-direction']]?.['space-between'] || []
